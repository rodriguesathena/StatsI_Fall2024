...
\end{figure}
\lstinputlisting[language=R, firstline=6, lastline=25]{PS02_answersAR.R}  
...
Code:
\end{Verbatim}
\lstinputlisting[language=R, firstline=28, lastline=28]{PS02_answersAR.R}  
	...
	\begin{table}[h]
		...
		\end{tabular}
	\end{table}
\lstinputlisting[language=R, firstline=34, lastline=34]{PS02_answersAR.R}  
...
\end{figure}
\lstinputlisting[language=R, firstline=48, lastline=49]{PS02_answersAR.R}  
