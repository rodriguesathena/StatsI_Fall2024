...
\end{figure}
\lstinputlisting[language=R, firstline=6, lastline=26]{PS02_answersAR.R}  
...
Code:
\end{Verbatim}
\lstinputlisting[language=R, firstline=29, lastline=29]{PS02_answersAR.R}  
	...
	\begin{table}[h]
		...
		\end{tabular}
	\end{table}
\lstinputlisting[language=R, firstline=35, lastline=37]{PS02_answersAR.R}  
...
\end{figure}
\lstinputlisting[language=R, firstline=51, lastline=52]{PS02_answersAR.R}  
